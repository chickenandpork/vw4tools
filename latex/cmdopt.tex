...
2. {\bfseries orderedtuples.\+csv} will cause an Ordered\+Tuples.\+csv file to be written, suitable for post-\/processing via csv-\/to-\/json.\+awk but allowing a user to more easily edit C\+S\+V for fine-\/tuning 
