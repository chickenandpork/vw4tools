\doxyref{csv-\/to-\/json.\+awk\+: Convert a \char`\"{}\+Ordered\+Tuples.\+csv\char`\"{} file to a J\+S\+O\+N Entity import}{p.}{csv-to-json} \section{csv-\/to-\/json.awk\+: Convert a \char`\"{}\+Ordered\+Tuples.\+csv\char`\"{} file to a J\+S\+O\+N Entity import}\label{csv-to-json}
\subsection{Overview}\label{csv-to-json_Overview}
...
\end{TabularC}
\subsection{Running this Script}\label{csv-to-json_running}
...
\end{DoxyVerb}
\subsection{Commandline Variables\+:}\label{csv-to-json_cmdline}
...
\end{DoxyItemize}\subsection{Usage (2 switches)}\label{csv-to-json_Example}
