...
\begin{DoxyCompactList}\small\item\em simple convenience interface to allow entity selection to be codified and created on-\/the-\/fly in a query A\+P\+I \end{DoxyCompactList}\item 
